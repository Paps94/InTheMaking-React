...
const achievementsContent = [
  ...
  { subTitle1: "Quality of Life Improvements", subTitle2: "I got approval from the head office to implement some QOL improvements for other departments. I.e Replace and optimise the code (Python) currently running through the warehouse scanners with something more modern like C++." },
];
